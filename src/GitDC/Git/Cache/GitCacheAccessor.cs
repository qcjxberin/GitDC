...
namespace GitDC.Git.Cache
{
    public abstract class GitCacheAccessor
    {
        ...
        public static void Initialize()
        {
            ...
            var cachePath = SiteSetting.Current.GitConfig.CachePath;
        ...
        where TAccessor : GitCacheAccessor<TReturn, TAccessor>
    {
        ...
        {
            var filename = Path.Combine(SiteSetting.Current.GitConfig.CachePath, GetCacheFile());
            if (File.Exists(filename))
            {
                try
                {
        ...
        protected override void Save()
        {
            ...
            var info = new FileInfo(Path.Combine(SiteSetting.Current.GitConfig.CachePath, GetCacheFile()));
