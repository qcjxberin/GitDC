...
namespace GitDC.Domain.Models {
    ...
    /// </summary>
    [DisplayName( "用户名" )]
    public partial class DCUsers : AggregateRoot<DCUsers,long>,IDelete {
        /// <summary>
        /// 初始化用户名
        /// </summary>
        public DCUsers() : this( 0 ) {
        }
        ...
        public DCUsers( long id ) : base( id ) {
        }
        ...
        /// 添加变更列表
        /// </summary>
        protected override void AddChanges( DCUsers other ) {
