...
namespace GitDC.Test.Integration.Dtos.dbo {
    ...
    public class WHLogsDtoTest {
        ...
        public void TestToDto() {
            ...
            Assert.Equal( WHLogsTest.WhId,dto.WhId );
            ...
            Assert.Equal( WHLogsTest.ResponseBody,dto.ResponseBody );
        ...
        public void TestToEntity() {
            ...
            Assert.Equal( WHLogsTest.WhId,entity.WhId );
            ...
            Assert.Equal( WHLogsTest.ResponseBody,entity.ResponseBody );
