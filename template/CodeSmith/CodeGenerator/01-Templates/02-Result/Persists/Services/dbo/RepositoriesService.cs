...
namespace GitDC.Service.Implements.dbo {
    ...
    /// 服务
    /// </summary>
    public class RepositoriesService : CrudServiceBase<RepositoriesPo, RepositoriesDto, RepositoriesQuery,long>, IRepositoriesService {
        /// <summary>
        /// 初始化服务
        /// </summary>
        /// <param name="unitOfWork">工作单元</param>
        /// <param name="repositoriesStore">存储器</param>
        ...
        protected override IQueryBase<RepositoriesPo> CreateQuery( RepositoriesQuery param ) {
            return new Query<RepositoriesPo,long>( param );
        }
    }
}